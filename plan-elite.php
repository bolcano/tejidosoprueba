...
<section id="work" class="bg-gray">
    <div class="container text-center wow fadeIn">
        ...
        <div class="col-md-6 col-md-offset-3">
            <form action="db/insertar-elite.php" method="post">
                ...
                <div class="form-group">
                    <label class="col-form-label" for="agregados">Agregados (Sólo Números)</label>
                    <input type="text" class="form-control" placeholder="Por cada agregado se le suma $24.000 al precio original" id="inputDefault" name="agregados">
                </div>
                <?php
                    if(!empty($_GET['msj'])) {
                        if ($_GET['msj'] == 5) {
