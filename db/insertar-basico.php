...
if(!empty($_POST)) {
    ...
    header('Location: plan-basico.php?msj=6');
}
...
function insertar($fecha, $ciudad, $departamento, $nombre, $identificacion, $fecha_nac, $ciudad_nac, $pais, $edo_civil, $padre, $ocupacion, $profesion, $residencia, $barrio, $telefono_1, $telefono_2, $celular, $direccion_oficina, $barrio_oficina, $correo, $f_nombre, $f_telefono, $f_aporte, $f_monto, $f_pago) {
    $sql = "INSERT INTO basico (idDonante, fecha, ciudad, departamento, nombre, identificacion, fecha_nac, ciudad_nac, pais, edo_civil, padre, ocupacion, profesion, residencia, barrio, telefono_1, telefono_2, celular, direccion_oficina, barrio_oficina, correo, f_nombre, f_telefono, f_aporte, f_monto, f_pago) 
        VALUES
    ...
    header('Location: ../plan-basico.php?msj=5');
}